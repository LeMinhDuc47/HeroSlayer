...
class ShortestPath {
    public:
        ...
        vector<Point> cungKhuDat(Point m, Point e) {
            vector<Point> dir;
    ...
    public:
        ...
        vector<Point> K1 = { Point(19,3), Point(22,3), Point(19,4), Point(22,4), Point(27,4), Point(30,4), Point (30,3), Point (27,3)};
        vector<Point> K2 = { Point(10,9), Point(13,9), Point(13,10), Point(10,10), Point(19,10), Point(30,10),Point(36,10), Point(36,9), Point(39,9), Point(39,10) };
        vector<Point> K3 = { Point(2,13), Point(5,13), Point(5,16), Point(10,16), Point(39,16), Point(48,16) };
    };

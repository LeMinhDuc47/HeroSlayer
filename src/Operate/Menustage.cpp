...
void Menustage::Draw() {
	...
	if (font->isFontLoaded()) {
		SDL_Texture* textTexture = font->renderText(to_string(gold), textColor, font->getFont(), Engine::GetInstance()->GetRenderer());
		if (textTexture) {
...
void Menustage::Load() {
	TextureManager::GetInstance()->Load("menu", "assets/menu/menu1.png");
	TextureManager::GetInstance()->Load("mode", "assets/menu/mode.png");
	TextureManager::GetInstance()->Load("pause", "assets/menu/pause.png");
	TextureManager::GetInstance()->Load("ModePK", "assets/menu/PK.png");
	TextureManager::GetInstance()->Load("win", "assets/menu/win.png");
	TextureManager::GetInstance()->Load("lose", "assets/menu/lose.png");

	TextureManager::GetInstance()->Load("op1", "assets/menu/op1.png");
	TextureManager::GetInstance()->Load("op2", "assets/menu/op2.png");
	TextureManager::GetInstance()->Load("bxh", "assets/menu/bxh.png");
}

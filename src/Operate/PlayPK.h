...
struct PlayerPK {
    ...
    string Path, skill_path;
    SDL_Rect choose;

    PlayerPK(bool isbuy = 0, int gia = 0, int hp = 0, int dame = 0, int skillframe = 0, int attackframe = 0, int skillframewidth = 0, int skillframeheight = 0, string path = "", string skillpath = "", SDL_Rect chose = { 0,0,0,0 }) :
